#ifndef ELLIPSE_LIO_INCLUDE_USE_IKFOM_H_
#define ELLIPSE_LIO_INCLUDE_USE_IKFOM_H_
...
inline MTK::get_cov<process_noise_ikfom>::type ProcessNoiseCov() {
  MTK::get_cov<process_noise_ikfom>::type cov = MTK::get_cov<process_noise_ikfom>::type::Identity();
  cov *= 1e-3;
  return cov;
}
...
#endif  // ELLIPSE_LIO_INCLUDE_USE_IKFOM_H_